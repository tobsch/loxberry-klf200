...
If you encounter issues after installation or upgrade:
...
Check that the config file exists and has your gateway settings:
```bash
cat /opt/loxberry/config/plugins/klf200/klf200.json
```

#### MQTT Connection Refused
Verify MQTT is configured in LoxBerry:
```bash
